...
use Fszsoft\Modules\Exceptions\InvalidAssetPath;
use Fszsoft\Modules\Exceptions\ModuleNotFoundException;
use Fszsoft\Modules\Process\Installer;
use Fszsoft\Modules\Process\Updater;
...
abstract class FileRepository implements RepositoryInterface, Countable
{
     ...
     * @return string
     * @throws \Fszsoft\Modules\Exceptions\ModuleNotFoundException
     */
